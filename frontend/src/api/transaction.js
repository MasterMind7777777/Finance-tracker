...
export const getSplitTransactions = () => authenticatedRequest('get', `/transaction_splits/`);
export const splitTransaction = (id, data) => authenticatedRequest('post', `/transactions/${id}/split_transaction/`, data);
export const acceptTransactionSplit = (id) => authenticatedRequest('put', `/transaction_splits/${id}/accept/`);
export const declineTransactionSplit = (id) => authenticatedRequest('put', `/transaction_splits/${id}/decline/`);
