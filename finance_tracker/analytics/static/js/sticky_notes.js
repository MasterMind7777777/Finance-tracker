$(function() {
  ...
  var fetchBoardURL = $("#fetch-boards-url").data("url");
  console.log("Fetch Board URL:", fetchBoardURL);
  // Perform an AJAX request to fetch the boards data
  $.ajax({
      url: fetchBoardURL,
      method: 'GET',
      success: function(response) {
          // Handle the successful response
          var dropdown = $('#board-dropdown');  // Get a reference to the dropdown element

          // Iterate over the boards data and add options to the dropdown
  ...
  // Event listener for the board dropdown
  $('#board-dropdown').change(function() {
    var selectedBoardID = $(this).val();
    if (selectedBoardID) {
        // Redirect to the selected board page
        window.location.href = "/analytics/" + selectedBoardID + "/";
    }
  });
